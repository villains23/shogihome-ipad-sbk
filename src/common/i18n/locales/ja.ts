...
export const ja: Texts = {
  ...
  saveOverwrite: "上書き保存",
  newRecord: "新規棋譜",
  newRecordKeepInitialPosition: "新規棋譜 (同じ初形)",
  newRecordHirateSetup: "新規棋譜（平手初形）",
  openRecord: "棋譜を開く",
  saveRecord: "棋譜を上書き保存",
  saveRecordAs: "棋譜を名前を付けて保存",
  openAutoSaveDirectory: "自動保存先を開く",
  ...
  csaProtocolV121WithPVComments: "CSAプロトコル1.2.1 読み筋コメント付き",
  host: "接続先ホスト",
  portNumber: "ポート番号",
  password: "パスワード",
  revealPassword: "パスワードを表示する",
  ...
  duplicatePositionSearch: "同一局面検索",
  duplicatePositions: "同一局面",
  duplicatePos: "同一局面",
  via: "経路",
  lastMove: "直前の指し手",
  nextMoves: "次の指し手",
  goToThisPosition: "この局面へ移動",
  noDuplicatePositions: "重複する局面はありません。",
  nDuplicatePositionsFound: (n: number) => `${n} 件の重複する局面が見つかりました。`,
  appearanceCount: "出現数",
  showList: "一覧を表示",
  setupPosition: "局面編集",
  ...
  pieceStand: "駒台",
  woodTexture: "木目",
  lightWoodyTexture: (n: number) => `木目（明${n}）`,
  warmWoodTexture: (n: number) => `木目（暖${n}）`,
  resin: "樹脂",
  transparent: "透過表示",
  boardOpacity: "盤の不透明度",
  pieceStandOpacity: "駒台の不透明度",
  recordOpacity: "棋譜の不透明度",
  promotionSelector: "成・不成の表示",
  ...
  twoColumns: "2列",
  sounds: "音",
  pieceSoundVolume: "駒音の大きさ",
  clockSoundVolume: "時計音の大きさ",
  clockSoundPitch: "時計音の高さ",
  ...
  alwaysOutputUTF8: "常に UTF-8 で出力",
  someOldShogiAppsCannotReadUTF8KifFiles:
    "一部の古い将棋アプリでは UTF-8 の KIF・KI2 ファイルを読み込めない場合があります。",
  strictDecodingMayFailToReadUTF8KifFiles:
    "文字コードの設定が「厳格」の場合、UTF-8 で書き出した KIF・KI2 ファイルの読み込みに失敗する可能性があります。",
  ...
  width: "幅",
  height: "高さ",
  newCustomProfile: "新規カスタムプロファイル",
  addCustomLayoutProfile: "新規レイアウトプロファイル",
  duplicateCurrentProfile: "現在のプロファイルを複製",
  ...
  rightControlBox: "右側メニュー",
  leftControlBox: "左側メニュー",
  topControlBox: "操作ボタン",
  legends: "凡例",
  historyMode: "履歴モード",
  headers: "ヘッダー",
  ...
  areYouSureWantToRemoveCurrentProfile: "現在のプロファイルを削除します。よろしいですか？",
  ...
  pieceSoundVolumeMustBe0To100Percent: "駒音の大きさには0%～100%の値を指定してください。",
  clockSoundVolumeMustBe0To100Percent: "時計音の大きさには0%～100%の値を指定してください。",
  clockSoundPitchMustBe220To880Hz: "時計音の高さには220Hz～880Hzの値を指定してください。",
