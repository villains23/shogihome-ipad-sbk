...
export const en: Texts = {
  ...
  newRecordKeepInitialPosition: "New Record (Keep Initial Position)",
  ...
  cut: "Cut",
  paste: "Paste",
  copyRecordAll: "Copy Record (All)",
  copyRecordFromCurrentPosition: "Copy Record (From Current Position)",
  asKIF: "As KIF",
  asKI2: "As KI2",
  asCSA: "As CSA",
  asUSI: "As USI",
  ...
  duplicatePos: "Duplicate",
  via: "Via",
  lastMove: "Last Move",
  nextMoves: "Next Moves",
  goToThisPosition: "Go to This Position",
  noDuplicatePositions: "No Duplicate Positions",
  nDuplicatePositionsFound: (n: number) => `${n} Duplicate Positions Found`,
